...
--
-- Host: localhost
-- Generation Time: May 23, 2015 at 10:42 PM
...
--
ALTER TABLE `exam_list`
ADD CONSTRAINT `exam_list_ibfk_1` FOREIGN KEY (`instructor_id`) REFERENCES `login_credentials` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ADD CONSTRAINT `question_bank_ibfk_3` FOREIGN KEY (`instructor_id`) REFERENCES `login_credentials` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ADD CONSTRAINT `result_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `login_credentials` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `user_info`
ADD CONSTRAINT `user_info_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `login_credentials` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
