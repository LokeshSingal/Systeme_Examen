...
--
-- Host: localhost
-- Generation Time: May 18, 2015 at 11:13 PM
...
--
ALTER TABLE `exam_list`
MODIFY `exam_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=124;
--
...
--
ALTER TABLE `result`
ADD CONSTRAINT `result_ibfk_1` FOREIGN KEY (`exam_id`) REFERENCES `exam_list` (`exam_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `result_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user_info` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
