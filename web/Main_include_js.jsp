    ...
    <!-- jQuery Knob Chart -->
    <script src="Theme/plugins/knob/jquery.knob.js" type="text/javascript"></script>
    <!-- daterangepicker -->
    ...
    <script src="Theme/dist/js/pages/dashboard.js" type="text/javascript"></script>    
    ...
    <!-- DATA TABES SCRIPT -->
    <script src="Theme/plugins/datatables/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="Theme/plugins/datatables/dataTables.bootstrap.min.js" type="text/javascript"></script>
    <!-- SlimScroll -->
